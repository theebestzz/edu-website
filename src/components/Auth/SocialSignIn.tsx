    ...
    <>
      <div className="flex gap-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg py-2 px-5 shadow-2xl hover:bg-primary hover:text-white duration-300 text-primary border"
        >
