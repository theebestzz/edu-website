    ...
    <section className="py-20">
      ...
      >
        <div className="sm:flex justify-between items-center pb-6">
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight my-4">
          ...
          <div>
            <button className="bg-transparent hover:bg-primary text-primary font-semibold hover:text-white py-3 px-4 border border-primary hover:border-transparent rounded duration-300">
              Sende Görüşlerini Belirt
            </button>
          </div>
        </div>
        <p className="text-lg font-medium pb-12">
          Kurslarımızla becerilerinizi geliştirin ve dünya standartlarındaki
          şirketlerden mentorluk alın.{" "}
        </p>
        <Slider {...settings}>
