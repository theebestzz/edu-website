          ...
          <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-7xl md:4px">
                Sizde Aramıza Katılın! <br /> Kurslarımızla Becerilerinizi
                Geliştirin
              </h1>
              <p className="mt-6 text-lg leading-8 text-black">
                Kurslarımızla becerilerinizi geliştirin ve yazılım dünyasında
                sizde yerinizi alın.
              </p>
                ...
                <div className="bannerBorder sm:pl-8">
                  ...
                  <div>
                    <h3 className="text-sm">
                      Google'da 5bin öğrenci tarafından değerlendirildi.
                    </h3>
                  </div>
                </div>
              </div>
